...
Goal fromProto(const strategy::Goal& x)
{
   ...
   result.id = x.common_props().id().guid();
   result.name = x.common_props().name();
   result.notes = x.common_props().notes();
...
strategy::Goal toProto(const Goal& x)
{
   ...
   result.mutable_common_props()->mutable_id()->set_guid(x.id);
   result.mutable_common_props()->set_name(x.name);
   result.mutable_common_props()->set_notes(x.notes);
...
public:
   ...
   virtual void ModifyGoal(::google::protobuf::RpcController* controller,
                       ...
                       ::google::protobuf::Closure* done)
   {
      mStrategy2.modifyGoal(fromProto(*request));
   ...
   virtual void GetGoals(::google::protobuf::RpcController* controller,
                       ...
                       ::google::protobuf::Closure* done)
   {
      for(auto x : mStrategy2.getGoals())
      {
   ...
   virtual void GetGoal(::google::protobuf::RpcController* controller,
                       ...
                       ::google::protobuf::Closure* done)
   {
      auto g = mStrategy2.getGoal(fromProto(*request));
      if(g)
      {
