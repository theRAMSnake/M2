...
GraphEditDialog::GraphEditDialog(const StrategyModel::Goal& goal, StrategyModel& model, ChallengeModel& chModel, TOnOkCallback cb)
...
, mGoal(goal)
{
   ...
   mGraphView = contents()->addWidget(std::make_unique<GraphView>(mModel, chModel));
